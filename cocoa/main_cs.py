...
from src.model.encdec import add_model_arguments, build_model, build_model_MUSE, build_model_BERT
...
if __name__ == '__main__':
    ...
    parser.add_argument('--word-embed-type', type=str, default="empty", help='Word embedding type')
    ...
    tokenizer = tokenize_type_based #tokenize_wp
    if args.test:
        model_args.dropout = 0
        data_generator = DataGenerator(args, None, None, dataset.test_examples, preprocessor, schema, model_args.num_items, mappings, use_kb, copy, tokenizer)
    else:
        data_generator = DataGenerator(args, dataset.train_examples, dataset.test_examples, None, preprocessor, schema, model_args.num_items, mappings, use_kb, copy, tokenizer)
