...
class BaseLexicon(object):
    ...
    def load_entities(self):
        for type_, values in self.schema.values.items():
            for value in values:
...
class Lexicon(BaseLexicon):
    ...
    def combine_repeated_entity(self, entity_tokens):
        ...
        '''
        is_entity = lambda x: not isinstance(x, str)
        prev_entity = None
        max_dist = 1
        cache = []
...
if __name__ == "__main__":
    ...
    parser.add_argument("--schema", type=str, help="path to schema to use",
                        default="/Users/d22admin/USCGDrive/Spring2020/CS644NLDialog/Project/cocoa/data/schema.json")
    parser.add_argument("--ranker-data", type=str, help="path to train data", default="/Users/d22admin/USCGDrive/Spring2020/CS644NLDialog/Project/cocoa/data/dev.json")
    ...
    parser.add_argument("--scenarios-json", help="Json of scenario information", type=str,
                        default="/Users/d22admin/USCGDrive/Spring2020/CS644NLDialog/Project/cocoa/data/scenarios.json")
    ...
    ranker = None #EntityRanker(args.annotated_examples_path, args.scenarios_json, args.ranker_data, args.transcripts)
    schema = Schema(path)
    lex = Lexicon(schema, learned_lex=False, entity_ranker=ranker, scenarios_json=args.scenarios_json, stop_words="/Users/d22admin/USCGDrive/Spring2020/CS644NLDialog/Project/cocoa/data/common_words.txt")
