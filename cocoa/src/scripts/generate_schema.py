...
if __name__ == '__main__':
    ...
    # Names
    #p = ".//*[@id='content']/table/tbody/tr/td[2]/table/tbody/tr[position()<last()]/td"
    #p = "//body/main/section/div/table/tbody/tr/td[2]/table/tbody/tr[position()<last()]/td"
    p = "//body/main/section[2]/div/div[2]/table/tbody/tr[1]/td[2]"
    #xpath = "//*[@id='content']/section[2]/div/div[2]/table/tbody/tr[1]/td[2]"
    xpath = "/html/body/main/section[2]/div/div[2]/table/tbody/tr[position()<last()]/td[2]"
    ...
    # Hobbies
    hobbies = scrape('https://en.wikipedia.org/wiki/List_of_hobbies', ".//*[@id='mw-content-text']/div/div/ul/li/a", args.cache_path)
